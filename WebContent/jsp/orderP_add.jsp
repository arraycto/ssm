                    ...
                    <div class="box_c">
                        <fieldset>
                            ...
                            <div class="box_c_item">
                                ...
                                <div class="fl">
                                    <label class="l_title">联系人：</label>
                                    	<input class="text_input w300" type="text" name="contact" id="supplierContact" placeholder="请输入供应商名称" onChange="getSupplierByNameAndContact(2)" required>
                            ...
                            <div class="box_c_item">
                                ...
                                <div class="fl">
                                    <label class="l_title">电话：</label>
                                    <input class="text_input w300" type="text" name="tele" id="supplierTele" placeholder="请输入供应商名称" onChange="setSuppOtherCondition()" required>
                                </div>
                                <div class="clear"></div>
                            </div>                                                 
                            <div class="box_c_item">
                                ...
                                <div class="fl">
                                    <label class="l_title">邮箱：</label>
                                    <input class="text_input w300" type="text" name="email" id="supplierEmail" placeholder="请输入供应商名称" onChange="setSuppOtherCondition()" email>
                                </div>
                                <div class="clear"></div>
                            </div>
                            <div class="box_c_item">
                                  ...
                                  <div class="fl">
                                    <label class="l_title">单位地址：</label>
                                    <input class="text_input w300" type="text" name="address" id="supplierAddress" placeholder="请输入供应商名称" onChange="setSuppOtherCondition()" required>
                                </div>
                                <div class="clear"></div>
                            </div>
